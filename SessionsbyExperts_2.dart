...
import 'sessionsby_experts2_model.dart';
export 'sessionsby_experts2_model.dart';

class SessionsbyExperts2Widget extends StatefulWidget {
  const SessionsbyExperts2Widget({super.key});

  @override
  State<SessionsbyExperts2Widget> createState() =>
      _SessionsbyExperts2WidgetState();
}

class _SessionsbyExperts2WidgetState extends State<SessionsbyExperts2Widget> {
  late SessionsbyExperts2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SessionsbyExperts2Model());
                              ...
                              child: Column(
                                ...
                                children: [
                                  FlutterFlowYoutubePlayer(
                                    url:
                                        'https://www.youtube.com/watch?v=wozv9eG9J14',
                                    autoPlay: false,
                                    looping: true,
                                    mute: false,
                                    showControls: true,
