...
import 'listof_yoga3_model.dart';
export 'listof_yoga3_model.dart';

class ListofYoga3Widget extends StatefulWidget {
  const ListofYoga3Widget({super.key});

  @override
  State<ListofYoga3Widget> createState() => _ListofYoga3WidgetState();
}

class _ListofYoga3WidgetState extends State<ListofYoga3Widget> {
  late ListofYoga3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListofYoga3Model());
                              ...
                              child: Column(
                                ...
                                children: [
                                  FlutterFlowYoutubePlayer(
                                    url:
                                        'https://www.youtube.com/watch?v=ZRS0dXit51Q',
                                    autoPlay: false,
                                    looping: true,
                                    mute: false,
                                    showControls: true,
