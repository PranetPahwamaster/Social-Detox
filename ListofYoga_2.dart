...
import 'listof_yoga2_model.dart';
export 'listof_yoga2_model.dart';

class ListofYoga2Widget extends StatefulWidget {
  const ListofYoga2Widget({super.key});

  @override
  State<ListofYoga2Widget> createState() => _ListofYoga2WidgetState();
}

class _ListofYoga2WidgetState extends State<ListofYoga2Widget> {
  late ListofYoga2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListofYoga2Model());
