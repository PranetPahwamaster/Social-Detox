                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (currentUserEmail ==
                                    ...
                                    if (_model.profileExists2?.email != null &&
                                        _model.profileExists2?.email != '') {
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (currentUserEmailVerified) {
                                    ...
                                    if (_model.profileExists?.email != null &&
                                        _model.profileExists?.email != '') {
                                      context.pushNamedAuth(
                                          'Home', context.mounted);
                                    } else {
                                      context.pushNamedAuth(
